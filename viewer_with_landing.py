...
def start_viewer(model_root, viewer_port=8080, args=None):
    ...
    # Change to egolifter directory for proper imports
    egolifter_dir = Path(__file__).parent / "egolifter"
    ...
    print(f"Working directory: {egolifter_dir}")
    process = subprocess.Popen(cmd, cwd=egolifter_dir)
    return process
